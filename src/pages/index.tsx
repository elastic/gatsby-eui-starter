        ...
        <EuiPageBody>
          ...
          <EuiPageContent>
            ...
            <EuiPageContentBody>
              <EuiText>
                <p>
                  This Gatsby EUI Starter is intended to help you quickly build
                  and deploy prototypes for Kibana apps with the EUI library.
                </p>
                ...
                <p>
                  ...
                  <EuiCode>
                    gatsby new my-app
                    https://github.com/elastic/gatsby-eui-starter
                  </EuiCode>
                ...
                <h3>Deploying</h3>
                <p>
                  Make sure that your repo has a <EuiCode>gh-pages</EuiCode>{' '}
